    ...
    >
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-4 text-gray-800 dark:text-gray-200">
          <p>
            O Conectai nasceu da ideia de que o talento está em toda parte, mas nem sempre é fácil de encontrar. Vivemos numa era digital, mas muitos profissionais incríveis ainda dependem exclusivamente do "boca a boca" para conseguir trabalho.
          </p>
          <p>
